...
export function WakaTimeIcon(props: ComponentProps<'svg'>) {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
        <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12 -5.373 12 -12C24 5.373 18.627 0 12 0m0 3.169c4.869 0 8.831 3.962 8.831 8.831 0 4.869 -3.962 8.831 -8.831 8.831S3.169 16.869 3.169 12 7.131 3.169 12 3.169m-1.172 11.422h-0.011a0.594 0.594 0 0 1 -0.464 -0.237L7.646 10.756a0.594 0.594 0 0 1 0.95 -0.714l2.249 2.99 0.643 -0.795a0.594 0.594 0 0 1 0.462 -0.22h0.001a0.593 0.593 0 0 1 0.462 0.222l0.618 0.768 3.534 -4.556a0.594 0.594 0 0 1 0.939 0.728L13.509 14.328a0.594 0.594 0 0 1 -0.464 0.23h-0.005a0.594 0.594 0 0 1 -0.463 -0.222l-0.628 -0.78 -0.659 0.814a0.594 0.594 0 0 1 -0.462 0.22"/></svg>
...
export function LoadingIcon(props: ComponentProps<'svg'>) {
    return (
        <svg aria-hidden="true" className="inline w-20 h-20 text-gray-200 animate-spin dark:text-gray-600 fill-red-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
